...
#define PID_TORQUE_KI_DEFAULT         142
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2428
#define PID_FLUX_KI_DEFAULT           142
...
#define OV_VOLTAGE_THRESHOLD_V          55 /*!< Over-voltage
                                                         threshold */
#define UD_VOLTAGE_THRESHOLD_V          40 /*!< Under-voltage
                                                          threshold */
#if 0
#define ON_OVER_VOLTAGE                 TURN_ON_R_BRAKE /*!< TURN_OFF_PWM,
                                                         ...
                                                         TURN_ON_LOW_SIDES */
#endif /* 0 */
#define R_BRAKE_SWITCH_OFF_THRES_V      44
