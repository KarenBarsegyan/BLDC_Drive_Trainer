...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, M1_DISSIPATIVE_BRK_Pin|USART_TX_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : USART_RX_EN_Pin */
  GPIO_InitStruct.Pin = USART_RX_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(USART_RX_EN_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : USART_TX_EN_Pin */
  GPIO_InitStruct.Pin = USART_TX_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(USART_TX_EN_GPIO_Port, &GPIO_InitStruct);
